...
ΑΜ ΔΣΑ 21034). Εξωτερικός συνεργάτης της εταιρίας είναι ο δικηγόρος 
Γιάννης Σάμιος. Η εταιρία αναλαμβάνει όλων των ειδών τις υποθέσεις σε 
όλο το φάσμα του Δικαίου. Ο Δημήτρης Ζιαμπάρας εξειδικεύεται στο 
Ηλεκτρονικό Έγκλημα και στο Πολεοδομικό Δίκαιο. Οι απαντήσεις σου να είναι 
...
while True:
   ...
   history.append({"role": "system", "content": "response.content"})
